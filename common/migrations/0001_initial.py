# Generated by Django 5.1 on 2024-08-14 07:51
...
# common.migrations.0013_auto_20210620
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "restoration_date",
                    models.DateTimeField(blank=True, editable=False, null=True, verbose_name="dernière restauration"),
                ),
                ("restored", models.BooleanField(editable=False, null=True, verbose_name="restauré")),
                (
                    "data",
                    common.fields.JsonField(
                        blank=True,
                ...
                ("data_size", models.PositiveIntegerField(editable=False, verbose_name="taille données")),
                (
                    "status",
                    models.CharField(
                        choices=[
                ...
                ("object_id", models.TextField(editable=False, verbose_name="identifiant")),
                ...
                ("reason", models.TextField(blank=True, editable=False, null=True, verbose_name="motif")),
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        blank=True, editable=False, null=True, verbose_name="modifications"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("types", models.ManyToManyField(blank=True, to="contenttypes.contenttype", verbose_name="types")),
                (
                    "method",
                    models.CharField(
                ...
                ("timeout", models.PositiveSmallIntegerField(default=30, verbose_name="délai d'attente")),
                ("retries", models.PositiveSmallIntegerField(default=0, verbose_name="tentatives")),
                ("delay", models.PositiveSmallIntegerField(default=0, verbose_name="délai entre tentatives")),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ("id", models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ("object_id", models.TextField(editable=False, verbose_name="identifiant")),
                ("object_uid", models.UUIDField(editable=False, unique=True, verbose_name="UUID")),
                (
                    "content_type",
                    models.ForeignKey(
                        editable=False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("deletion_date", models.DateTimeField(blank=True, null=True, verbose_name="date de suppression")),
                (
                    "content_type",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("reset_date", models.DateTimeField(blank=True, null=True, verbose_name="date réinitialisation")),
                (
                    "extra",
                    common.fields.JsonField(
                        blank=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("data_size", models.PositiveIntegerField(editable=False, verbose_name="taille données")),
                ("field_name", models.CharField(editable=False, max_length=100, verbose_name="nom du champ")),
                ("old_value", models.TextField(blank=True, editable=False, null=True, verbose_name="ancienne valeur")),
                ("new_value", models.TextField(blank=True, editable=False, null=True, verbose_name="nouvelle valeur")),
                (
                    "status_m2m",
                    models.CharField(
                        blank=True,
                ...
                ("editable", models.BooleanField(default=True, editable=False, verbose_name="éditable")),
            ],
            options={
